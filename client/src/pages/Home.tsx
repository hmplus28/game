...
export default function Home() {
  ...
  return (
    <AppShell title="درود، آرین" eyebrow="مرکز مسابقه">
      <section className="dashboard-hero premium-panel">
        ...
        <div className="hero-copy">
          ...
          <p>میز بعدی آماده است. مسیرت تا Platinum از یک تصمیم دقیق شروع می‌شود.</p>
          <div className="hero-actions">
            <button className="primary-button" onClick={() => navigate("/play")}><Gamepad2 size={17} /> شروع بازی</button>
            <button className="ghost-button" onClick={() => navigate("/tournaments")}><Swords size={16} /> مسابقات امروز</button>
          </div>
      ...
      <div className="section-title-row"><div><h2>مسیر بازی را انتخاب کن</h2><p>هر حالت، ریتم و پاداش متفاوتی دارد.</p></div><Link className="text-link" href="/play">همهٔ حالت‌ها <ChevronLeft size={14} /></Link></div>
      ...
      <section className="stats-season-grid">
        <article className="premium-panel stat-panel">
          <header><div className="panel-label">کارنامهٔ این فصل<b>جریان بازی تو</b></div><span className="status-badge active">روند صعودی</span></header>
